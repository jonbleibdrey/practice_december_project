...
class BodiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create body" do
    assert_difference('Body.count') do
      post bodies_url, params: { body: { arm: @body.arm, chest: @body.chest, head: @body.head, leg: @body.leg } }, as: :json
    end
  ...
  test "should update body" do
    patch body_url(@body), params: { body: { arm: @body.arm, chest: @body.chest, head: @body.head, leg: @body.leg } }, as: :json
    assert_response 200
  end
